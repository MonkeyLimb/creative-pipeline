...
function mapCSVRow(row, index) {
  return {
    ...
    hook: row.hook_text || row.canva_frame_1_hook_text || "",
    subtext: row.subtext || row.canva_frame_2_subtext || "",
    cta: row.cta || row.canva_frame_3_cta || "",
    canva_prompt: row.visual_prompt || row.ai_visual_prompt_for_backgroundbroll || "",
